...
window.MARKETS = {
  ...
  // ── GEELONG ──────────────────────────────────────────────────────────────
  geelong: {
    // ── Monthly update fields ── Source: HtAG Analytics VIC215, period ending July 2026
    heroPrice: '~$916k', heroYield: '3.0–3.2%', heroPopulation: '271k', heroVacancy: '1.7%',
    houseMedian: 915863, unitMedian: 710623,
    houseRentRange: '$520–$530', unitRentRange: '$430–$440',
    houseYieldRange: '3.0–3.2%', unitYieldRange: '3.1–3.3%',
    vacancyRate: 1.7, daysOnMarket: 33, clearanceRate: 70, propertiesListed: 345,
    popTotal: 271000, popGrowth: 2.1, medianAge: 37, ownerOccupier: 62, employed: 63, unemployment: 4.1,
    conditions: {
    ...
    housePerf: { yr1:{val:9.1,bar:91}, yr3:{val:0.0,bar:0}, yr5:{val:3.7,bar:37}, yr10:{val:6.5,bar:65} },
    unitPerf:  { yr1:{val:0.0,bar:0}, yr3:{val:-2.9,bar:0}, yr5:{val:-1.7,bar:0}, yr10:{val:4.4,bar:44} },
    population:  [238000,244000,249000,254000,258000,261000,263000,266000,268000,271000],
    popYears:    [2017,2018,2019,2020,2021,2022,2023,2024,2025,2026],
    housePrice:  [490000,530000,560000,575000,590000,670000,720000,695000,680000,915863],
    unitPrice:   [320000,345000,360000,368000,380000,415000,450000,435000,425000,710623],
    priceYears:  [2017,2018,2019,2020,2021,2022,2023,2024,2025,2026],
    yieldHouse:  [4.8,4.7,4.5,4.3,4.1,3.8,3.9,4.1,4.2,3.0],
    yieldUnit:   [5.5,5.4,5.2,5.0,4.8,4.6,4.8,5.0,5.1,3.2],
    yieldYears:  [2017,2018,2019,2020,2021,2022,2023,2024,2025,2026],
    vacancy:     [2.1,1.9,1.6,1.8,1.2,0.7,0.8,0.9,0.8,1.7],
    ...
    htMonths:    ["Aug '25","Sep '25","Oct '25","Nov '25","Dec '25","Jan '26","Feb '26","Mar '26","Apr '26","May '26","Jun '26","Jul '26"],
    htHousePrice:[842607,846183,851587,857409,862178,871498,880152,888183,897777,906738,911378,915863],
    htUnitPrice: [708176,705928,704125,701041,698724,699747,701631,703662,705743,707903,709262,710623],
    htHouseRent: [506,508,509,511,513,515,518,520,522,523,524,525],
    htUnitRent:  [420,422,424,426,427,428,430,431,432,434,434,435],
  },
