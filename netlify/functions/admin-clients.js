...
export default async (req) => {
  ...
  if (req.method === 'PUT') {
    ...
    const { id, name, markets, active, password, action, datesArchived, pipelineStage, status, engagementNumber, referralSource, referrerId, customFields, dealProfessionals, manualFee } = body;
